function [R,T,A,nin] = graph_RAT(lambda,mediums,layers,data,angles,pol) 
...
[R,T,A] = multi_layer_in(width, index, lambda, angles, n_in, pol);

%%%% Call function Graph-image to graph the results.

graph_image(lambda,angles,R,T,A,n_in(1))
